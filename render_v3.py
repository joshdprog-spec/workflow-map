...
.prod{background:linear-gradient(180deg,color-mix(in srgb,var(--acc) 9%,var(--surface)),var(--surface));border:1px solid color-mix(in srgb,var(--acc) 35%,var(--line));border-radius:14px;padding:16px 18px;display:flex;flex-direction:column;gap:8px}
